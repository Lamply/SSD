from ssd.data.datasets import VOCDataset, COCODataset, RotateDataset
from .coco import coco_evaluation
from .voc import voc_evaluation
from .rotate import rotate_evaluation
...
def evaluate(dataset, predictions, output_dir, **kwargs):
    ...
    elif isinstance(dataset, RotateDataset):
        return rotate_evaluation(**args)
    else:
